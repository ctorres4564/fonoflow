...
const actions=z.enum(['patient.created','patient.updated','patient.deleted','record.viewed','record.exported','evolution.created','evolution.revised','evolution.deleted','evolution.amendment_added','evolution.annulled','anamnesis.updated','document.uploaded','document.deleted','appointment.status_changed','HOME_CARE_VISIT_CREATED','HOME_CARE_DEPARTURE_RECORDED','HOME_CARE_ARRIVAL_RECORDED','HOME_CARE_SERVICE_STARTED','HOME_CARE_VISIT_COMPLETED','HOME_CARE_PATIENT_ABSENT','HOME_CARE_VISIT_CANCELLED','HOME_CARE_OCCURRENCE_RECORDED','HOME_CARE_TRAVEL_UPDATED'])
