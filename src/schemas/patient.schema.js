...
export const patientV2Schema = z.object({
  ...
  status: z.enum(['active','inactive','discharged','archived','restricted']), search: z.object({ normalizedName: z.string(), normalizedPhone: z.string().nullable().optional() }).optional(), createdAt: timestampSchema, createdBy: z.string().min(1), updatedAt: z.unknown().optional(), updatedBy: z.string().optional(),
}).passthrough()
